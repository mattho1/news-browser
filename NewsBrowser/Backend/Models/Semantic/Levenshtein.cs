...
{
    // code from site: https://www.codeproject.com/Articles/13525/Fast-memory-efficient-Levenshtein-algorithm-2
    public class Levenshtein
    {
        ...
        public double LevenshteinSimilarity(string txt1, string txt2)
        {
            return 1.0 - LevenshteinDistance(txt1, txt2);
        }
        ...
        public double LevenshteinDistance(String sNew, String sOld)
        {
            int[,] matrix;              // matrix
            ...
            return (double) ((double) ((100.0 * matrix[sNewLen, sOldLen])) / (double) max) / 100.0;
        }
    }
}
